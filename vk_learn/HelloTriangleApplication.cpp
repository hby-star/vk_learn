...
const bool enableDetailedDebugging = false;
...
private:
	...
	void DisplayDetailedDebugging()
	{
		if (enableDetailedDebugging)
		{
			// Display the Vulkan instance layers
			...
			// Display the Vulkan instance extensions
			...
			// Display the Vulkan device extensions
			...
			// Display the Vulkan queue families
			...
			// Display the Vulkan physical device properties
			...
			// Display the Vulkan Queue Family Indices
			...
			// Display the Vulkan swap chain support details
			SwapChainSupportDetails swapChainSupport = querySwapChainSupport(physicalDevice);
			std::cout << "Swap chain support details:" << std::endl;
			...
			std::cout << "\tCurrent extent: " << swapChainSupport.capabilities.currentExtent.width << ", " << swapChainSupport.capabilities.currentExtent.height << std::endl;
			std::cout << "\tMin extent: " << swapChainSupport.capabilities.minImageExtent.width << ", " << swapChainSupport.capabilities.minImageExtent.height << std::endl;
			std::cout << "\tMax extent: " << swapChainSupport.capabilities.maxImageExtent.width << ", " << swapChainSupport.capabilities.maxImageExtent.height << std::endl;
			std::cout << "\tMax image array layers: " << swapChainSupport.capabilities.maxImageArrayLayers << std::endl;
			std::cout << "\tSupported transforms: " << swapChainSupport.capabilities.supportedTransforms << std::endl;
			std::cout << "\tCurrent transform: " << swapChainSupport.capabilities.currentTransform << std::endl;
			std::cout << "\tSupported composite alpha: " << swapChainSupport.capabilities.supportedCompositeAlpha << std::endl;
			std::cout << "\tSupported usage: " << swapChainSupport.capabilities.supportedUsageFlags << std::endl;
	...
	// A graphics pipeline is a sequence of operations that take the vertices and textures of your meshes all the way to the pixels in the framebuffer
